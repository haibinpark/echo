...
public class UIHelper {
    ...
    public static int dipToPx(float dip) {
        return (int) (dip * App.Companion.getInstance().getResources().getDisplayMetrics().density + 0.5f);
    }
    ...
    public static int pxToDip(float pxValue) {
        final float scale = App.Companion.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static int getScreenWidthPix(@Nullable Context context) {
        if (context == null) context = App.Companion.getInstance();
...
//            KLog.i("showSoftKeyboard", " isSuccess   >>>   " + success);
    ...
    public static void ToastMessage(String msg) {
        Toast.makeText(App.Companion.getInstance(), msg, Toast.LENGTH_LONG).show();
    }
    ...
    public static int getColor(int colorResId) {
        try {
            return App.Companion.getInstance().getResources().getColor(colorResId);
        } catch (Exception e) {
