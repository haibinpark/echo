...
public class CommonDialogOneBtnNoTitle extends Dialog {

    public CommonDialogOneBtnNoTitle(Context context) {
        super(context);
    }

    public CommonDialogOneBtnNoTitle(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }

    public CommonDialogOneBtnNoTitle(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        private CommonDialogOneBtnNoTitle mDialog;
        ...
        private void initView() {
            ...
            mView = mInflater.inflate(R.layout.dialog_common_one_btn_notitle, null);
        ...
        public CommonDialogOneBtnNoTitle create() {
            mDialog = new CommonDialogOneBtnNoTitle(context, R.style.ComWinTransBackHalfDia);
