 ...
 */
open class CommonSubscriberWithError<T>(private val mView: BaseView, private val doNext: (T) -> Unit, private val error: (Throwable) -> Unit) : CommonSubscriber<T>(mView, doNext) {
