...
public class CommonDialogEmpty extends Dialog {
    ...
    public static class Builder {
        ...
        public CommonDialogEmpty create() {
            mDialog = new CommonDialogEmpty(context, R.style.ComWinTransBackHalfDia);
     ...
     * 实名认证dialog
     */
    public static View getPersonAuthenView(Context c, String phone, OnDialogBtnListener listener, OnDialogBtnListener btnListener) {
    ...
    public static View getFinishApproveView(Context c, OnDialogBtnListener listener) {
        View view = LayoutInflater.from(c).inflate(R.layout.dialog_content_finish_approve, null);
        TextView tv_bottom_btn = view.findViewById(R.id.tv_bottom_btn);
        tv_bottom_btn.setOnClickListener(v -> {
            if (listener != null) {
                listener.onClick("");
