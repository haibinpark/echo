...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) Objects.requireNonNull(App.Companion.getInstance()).getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
     ...
     * @return
     */
    public static List<ResolveInfo> getApps(Context context) {
